...
<%
	...
	/* 회원정보를 저장하는 MemberBean 객체를 생성 */
	MemberBean m2 = new MemberBean("son","1234","손흥민","song@test.com");
	
	/* 전송된 회원 정보와 자바 코드로 생성한 회원 정보를 ArrayList에 저장 */
	membersList.add(m1);
	membersList.add(m2);
	
	/* 회원 정보가 저장된 membersList를 memberList라는 키로 HashMap에 저장 */
...
<body>
	<table border="1"  align="center" >
		...
		<!-- HashMap 이름 뒤에 마침표 연산자로 저장 시 사용한 key를 이용하여 value를 가져옴 -->
	   	...
	   	<!-- HashMap에 저장된 ArrayList에 마침표로 접근한 후 다시 각각의 속성에 마침표로
	   		접근하여 첫 번쨰 회원 정보를 출력 -->
	   	<tr align=center>
